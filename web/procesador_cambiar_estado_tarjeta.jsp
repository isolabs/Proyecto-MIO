<%-- 
    Document   : procesador_cambiar_estado_tarjeta
    Created on : 29-feb-2016, 0:37:29
    Author     : Alejandro
--%>
...
Controlador_Tarjeta uncontrolador = new Controlador_Tarjeta();
      ...
      int id_tarjeta = Integer.valueOf(request.getParameter("id_tarjeta"));
       ...
       int resultado = uncontrolador.cambiar_estado_tarjeta(id_tarjeta);
       %>
<!DOCTYPE html>
...
<head>
    ...
    <title>Procesador cambiar estado de una tarjeta</title>
	<!-- BOOTSTRAP STYLES-->
 ...
 <body>
    ...
    <%
       ...
       switch(resultado){
           case 0: out.println("Se cambio el estado de la tarjeta "+ id_tarjeta);break;
           case -1: out.println("la tarjeta con el id "+ id_tarjeta +" no existe en nuestros registros");break;
