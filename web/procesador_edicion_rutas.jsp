...
<%
    ...
    int resultado = uncontrolador.modificar_ruta(id_ruta, nombre, descripcion);
%>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
            ...
            <div class="panel-body">
                <center>
                    <%
                        ...
                        switch (resultado) {
                            case 0:
                                out.println("La ruta '" + nombre + "' ha sido modificada");
                                break;
                            case 1:
        ...
        <script>
            function goBack() {
            <%if (resultado == 0) {%>
                location.href = "<%out.print("rutas.jsp");%> "<%} else {
