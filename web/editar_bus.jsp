    ...
    <body>
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="procesador_edicion_bus.jsp?placa=<%out.print(request.getParameter("placa"));%>" class="form-group" method="post" >
                    ...
                    <input type="text" name="placa" value="<% out.print(request.getParameter("placa"));  %>"  pattern="[^<>]+"placeholder="Ejemplo: ABC-123" title="Debe ingresar un dato correcto" id="placa" class ="form-control" disabled></input>
                    ...
                    <input type="text" value ="<% out.print(bus_modificar.getNumero_pasajeros()); %>"pattern="[^<>][0-9].{0,2}" name="num_pasajeros" id="num_pasajeros" class ="form-control" required="required"></input>
                    ...
                    <center>    <input   style="margin-top: 10px"  type="submit" class="btn btn-primary" value="Modificar Bus"></center>
